...
var     REARG_FLAG$1 = 256;
    ...
    function arrayLikeKeys(value, inherited) {
      var result = isArray(value) || isString(value) || isArguments(value) ? baseTimes(value.length, String) : [];
    ...
    function isError(value) {
      ...
      return objectToString$4.call(value) == errorTag || typeof value.message == 'string' && typeof value.name == 'string';
    }
...
var     weakMapTag$1 = '[object WeakMap]';
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$11 = objectProto$18.hasOwnProperty;
...
var     uint32Tag$2 = '[object Uint32Array]';
    ...
    typedArrayTags[argsTag$3] = typedArrayTags[arrayTag$2] = typedArrayTags[arrayBufferTag$3] = typedArrayTags[boolTag$3] = typedArrayTags[dataViewTag$4] = typedArrayTags[dateTag$3] = typedArrayTags[errorTag$3] = typedArrayTags[funcTag$2] = typedArrayTags[mapTag$4] = typedArrayTags[numberTag$3] = typedArrayTags[objectTag$3] = typedArrayTags[regexpTag$3] = typedArrayTags[setTag$4] = typedArrayTags[stringTag$4] = typedArrayTags[weakMapTag$2] = false;
     ...
     * of values.
     */
    var objectToString$7 = objectProto$21.toString;
    ...
    function baseIsTypedArray(value) {
        return isObjectLike(value) && isLength(value.length) && !!typedArrayTags[objectToString$7.call(value)];
    }
...
var     PARTIAL_COMPARE_FLAG$5 = 2;
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$14 = objectProto$22.hasOwnProperty;
...
var     nativeMin$3 = Math.min;
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$15 = objectProto$23.hasOwnProperty;
    ...
    function assignInDefaults(objValue, srcValue, key, object) {
      if (objValue === undefined || eq(objValue, objectProto$23[key]) && !hasOwnProperty$15.call(object, key)) {
        return srcValue;
      }
      return objValue;
    }
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$16 = objectProto$24.hasOwnProperty;
     ...
     * of values.
     */
    var objectToString$8 = objectProto$24.toString;
    ...
    function isPlainObject(value) {
      if (!isObjectLike(value) || objectToString$8.call(value) != objectTag$4 || isHostObject(value)) {
        return false;
      }
...
var     REARG_FLAG$2 = 256;
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$17 = objectProto$25.hasOwnProperty;
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$18 = objectProto$26.hasOwnProperty;
...
var     setTag$6 = '[object Set]';
    ...
    function isEmpty(value) {
      ...
      for (var key in value) {
        if (hasOwnProperty$20.call(value, key) && !(isProto && key == 'constructor')) {
          return false;
        }
      }
      return !(nonEnumShadows$1 && nativeKeys(value).length);
    }
...
var     MAX_ARRAY_LENGTH$3 = 4294967295;
    ...
    var object = {
      ...
      pickBy: pickBy, result: result$1, set: set$1, setWith: setWith, toPairs: toPairs,
...
var     nativeMin$12 = Math.min;
    ...
    */
    ...
    (function () {
      ...
      lodash.each(srces, function (src) {
        ...
        request.onload = function () {
          ctx.decodeAudioData(request.response, function (buffer) {
            ...
            if (count < 1) {
              bufferArray = audio.bufferArray = lodash.toArray(buffers);
              loaded = true;
